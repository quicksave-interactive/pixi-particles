 ...
 * Compiled Fri, 18 Jun 2021 12:11:56 UTC
 *
 * pixi-particles is licensed under the MIT License.
 * http://www.opensource.org/licenses/mit-license
 */
this.PIXI = this.PIXI || {};
(function (exports, core, constants, math, sprite, settings, ticker$1, display) {
    'use strict';
     ...
     * @hidden
     */
    var TextureFromString = core.Texture.from;
    ...
    ***************************************************************************** */
    ...
    var Particle = /** @class */ (function (_super) {
        ...
        function Particle(emitter) {
            ...
            _this.acceleration = new math.Point();
            _this.maxSpeed = NaN;
        ...
        Particle.prototype.applyArt = function (art) {
            this.texture = art || core.Texture.EMPTY;
        };
        /**
     ...
     * @hidden
     */
    var ticker = ticker$1.Ticker.shared;
    /**
     * @hidden
     */
    var helperPoint = new math.Point();
    /**
     * A particle emitter.
     */
    var Emitter = /** @class */ (function () {
        ...
        Emitter.prototype.init = function (art, config) {
            ...
            if (acceleration && (acceleration.x || acceleration.y)) {
                ...
                this.acceleration = new math.Point(acceleration.x, acceleration.y);
                this.maxSpeed = config.maxSpeed || NaN;
            }
            else {
                this.acceleration = new math.Point();
            }
            // set up the scale
            if (config.scale) {
            ...
            this.spawnPos = new math.Point(config.pos.x, config.pos.y);
        ...
        Emitter.prototype.parseSpawnType = function (config) {
            ...
            switch (config.spawnType) {
                case 'rect':
                    ...
                    this.spawnRect = new math.Rectangle(spawnRect.x, spawnRect.y, spawnRect.w, spawnRect.h);
                    break;
                case 'circle':
                    this.spawnType = 'circle';
                    this._spawnFunc = this._spawnCircle;
                    spawnCircle = config.spawnCircle;
                    this.spawnCircle = new math.Circle(spawnCircle.x, spawnCircle.y, spawnCircle.r);
                    break;
                case 'ring':
                    this.spawnType = 'ring';
     ...
     * @hidden
     */
    var helperPoint$1 = new math.Point();
    /**
    ...
    var PathParticle = /** @class */ (function (_super) {
        ...
        function PathParticle(emitter) {
            ...
            _this.initialPosition = new math.Point();
            _this.movement = 0;
            return _this;
        }
        /**
    ...
    var AnimatedParticle = /** @class */ (function (_super) {
        ...
        AnimatedParticle.prototype.update = function (delta) {
            ...
            if (lerp >= 0) {
                ...
                this.texture = this.textures[frame] || this.textures[this.textures.length - 1] || core.Texture.EMPTY;
            }
            return lerp;
        };
        /**
    ...
    var LinkedListContainer = /** @class */ (function (_super) {
        ...
        LinkedListContainer.prototype.getLocalBounds = function (rect, skipChildrenUpdate) {
            ...
            var result = display.DisplayObject.prototype.getLocalBounds.call(this, rect);
